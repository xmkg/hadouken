...
function(setup_coverage_targets)
    cmake_parse_arguments(ARGS "" "TARGET_NAME;TYPE;" "LINK;COVERAGE_TARGETS;COVERAGE_FILTER_PATTERN;" ${ARGN})
    if(NOT DEFINED ARGS_TARGET_NAME)
    ...
    if(NOT DEFINED ARGS_COVERAGE_FILTER_PATTERN)
        # Default filter pattern
        set(ARGS_COVERAGE_FILTER_PATTERN "*")
    endif()
    ...
    if(NOT ${ARGS_TYPE} STREQUAL "INTERFACE")
        if(${PB_PARENT_PROJECT_NAME_UPPER}_TOOLCONF_USE_GCOV AND GCOV)
            ...
            if(${PB_PARENT_PROJECT_NAME_UPPER}_TOOLCONF_USE_LCOV AND LCOV)
                # dummy.component-x
                SETUP_TARGET_FOR_COVERAGE_LCOV(NAME ${TARGET_NAME}.lcov EXECUTABLE ${TARGET_NAME} DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/../ FILTER_PATTERN ${ARGS_COVERAGE_FILTER_PATTERN} LCOV_ARGS --directory ${CMAKE_SOURCE_DIR} --no-external)
            endif()
