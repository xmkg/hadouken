...
hdk_log_set_context("hdk.tc.gtest")
...
if(${HDK_ROOT_PROJECT_NAME_UPPER}_TOOLCONF_USE_GOOGLE_TEST)
    ...
    hdk_log_status("Configuring tool `Google Test` (`${${HDK_ROOT_PROJECT_NAME_UPPER}_HADOUKEN_CONAN_GOOGLE_TEST_PKG_NAME}/${${HDK_ROOT_PROJECT_NAME_UPPER}_HADOUKEN_CONAN_GOOGLE_TEST_VERSION}`)")
    hdk_log_indent(1)
